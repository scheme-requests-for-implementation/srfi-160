;;;;;; SRFI 160: @Vector library                           -*- Scheme -*-
;;;
;;; $Id$
;;;
;;; Taylor Campbell wrote this code; he places it in the public domain.
;;; Will Clinger [wdc] made some corrections, also in the public domain.
;;; John Cowan modified this code for SRFI 160; his changes are also in
      ...
      (if (null? vecs)
        ...
        (let ((vec (car vecs)) (start (car starts)) (end (car ends)))
          ...
          (loop (+ at (- end start))
                ...
                (cdr starts)
                (cdr ends))))))
  ;; put them all together, they spell @VECTOR-APPEND-SUB@VECTORS
